...
//				session.setAttribute("liketest", 0);
	...
	public void sendmail(String email) {
		...
		try {
			...
			message.setContent("<h3 style='color:#FF6088;'>♥ InterHash# ♥</h3><hr style='border: dashed 0.5px; color:#7A7A7A;'>인증번호는 <b style='color:#FF6088;'>"+key+"</b> 입니다:-)<br>","text/html; charset=UTF-8;");
